...
const Dashboard = () => {
  ...
  // ✅ 1. مكون إشعار مكافأة بطل الجولة (النقطة الذهبية)
  ...
  // 🆕 دالة استيراد ملف الإكسل (نتائج المباريات)
  ...
  // 🆕 دالة استيراد سجل مخالفات التشكيلة (Missed Deadlines)
