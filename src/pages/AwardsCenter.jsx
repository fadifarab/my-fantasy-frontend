                        ...
                        <>
                            ...
                            <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '20px', marginBottom: '25px' }}>
                                    <StatCard title={activeTab === 'season' ? 'بطل الموسم' : 'فريق الفترة'} name={awards?.bestTeam?.name || '--'} value={awards?.bestTeam?.totalScore || '0'} subText="نقطة" icon={<FaTrophy size={25} color="#00c853"/>} color="#00c853" />
                                    <StatCard title="لاعب الفترة (MVP)" name={awards?.bestPlayer?.name || '--'} value={awards?.bestPlayer?.score || '0'} subText="نقطة" icon={<FaStar size={25} color="#2979ff"/>} color="#2979ff" />
                                </div>
